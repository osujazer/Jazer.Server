...
namespace Jazer.Server.Migrations
{
    ...
    [Migration("20250622194625_AddUserStatisticsEntities")]
    partial class AddUserStatisticsEntities
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Jazer.Server.Entities.UserPeakRank", b =>
                {
                    b.Property<int>("UserId")
                        .HasColumnType("integer")
                        .HasColumnName("user_id");
                    ...
                    b.ToTable("user_peak_ranks");
                });

            modelBuilder.Entity("Jazer.Server.Entities.UserStatistics", b =>
                {
                    b.Property<int>("UserId")
                        .HasColumnType("integer")
                        .HasColumnName("user_id");
                    ...
                    b.Property<int>("JazerPoints")
                        .HasColumnType("integer")
                        .HasColumnName("jazer_points");
            ...
            modelBuilder.Entity("Jazer.Server.Entities.UserPeakRank", b =>
                {
                    b.HasOne("Jazer.Server.Entities.User", "User")
                        .WithOne("UserPeakRank")
                        .HasForeignKey("Jazer.Server.Entities.UserPeakRank", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Jazer.Server.Entities.UserStatistics", b =>
                {
                    b.HasOne("Jazer.Server.Entities.User", "User")
                        ...
                        .HasForeignKey("Jazer.Server.Entities.UserStatistics", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
